...
@order_sessions.each do |os|
    json.set! os.id do
        json.extract! os, :id, :restaurant_id, :name, :user_id, :accepted, :accepted_at, :filled, :filled_at, :arrived, :arrived_at, :completed, :completed_at, :subtotal, :taxes, :service_fee, :special_offers, 
